...
// 4.16.2
if ($installer->tableExists('custom_options_option_description') && !$installer->tableExists('mageworx_custom_options_option_description')) {
    $installer->run("RENAME TABLE custom_options_option_description TO {$this->getTable('mageworx_customoptions/option_description')};");
}

if ($installer->tableExists('custom_options_group') && !$installer->tableExists('mageworx_custom_options_group')) {
    $installer->run("RENAME TABLE custom_options_group TO {$this->getTable('mageworx_customoptions/group')};");
}

if ($installer->tableExists('custom_options_relation') && !$installer->tableExists('mageworx_custom_options_relation')) {
    $installer->run("RENAME TABLE custom_options_relation TO {$this->getTable('mageworx_customoptions/relation')};");
}

if ($installer->tableExists('custom_options_group_store') && !$installer->tableExists('mageworx_custom_options_group_store')) {
    $installer->run("RENAME TABLE custom_options_group_store TO {$this->getTable('mageworx_customoptions/group_store')};");
}

if ($installer->tableExists('custom_options_option_default') && !$installer->tableExists('mageworx_custom_options_option_default')) {
    $installer->run("RENAME TABLE custom_options_option_default TO {$this->getTable('mageworx_customoptions/option_default')};");
}

if ($installer->tableExists('custom_options_option_type_tier_price') && !$installer->tableExists('mageworx_custom_options_option_type_tier_price')) {
    $installer->run("RENAME TABLE custom_options_option_type_tier_price TO {$this->getTable('mageworx_customoptions/option_type_tier_price')};");
}

if ($installer->tableExists('custom_options_option_type_image') && !$installer->tableExists('mageworx_custom_options_option_type_image')) {
    $installer->run("RENAME TABLE custom_options_option_type_image TO {$this->getTable('mageworx_customoptions/option_type_image')};");
}

if ($installer->tableExists('custom_options_option_view_mode') && !$installer->tableExists('mageworx_custom_options_option_view_mode')) {
    $installer->run("RENAME TABLE custom_options_option_view_mode TO {$this->getTable('mageworx_customoptions/option_view_mode')};");
}

if ($installer->tableExists('custom_options_option_type_special_price') && !$installer->tableExists('mageworx_custom_options_option_type_special_price')) {
    $installer->run("RENAME TABLE custom_options_option_type_special_price TO {$this->getTable('mageworx_customoptions/option_type_special_price')};");
}

if ($installer->tableExists('custom_options_option_type_description') && !$installer->tableExists('mageworx_custom_options_option_type_description')) {
    $installer->run("RENAME TABLE custom_options_option_type_description TO {$this->getTable('mageworx_customoptions/option_type_description')};");
}
