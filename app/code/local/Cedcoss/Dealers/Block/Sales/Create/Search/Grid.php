<?php
class Cedcoss_Dealers_Block_Sales_Create_Search_Grid extends Mage_Adminhtml_Block_Sales_Order_Create_Search_Grid
{
	public function __construct()
    {
        //die('jh');
		parent::__construct();
        $this->setId('dealers_create_search_grid'.time());
		...
		$this->setTemplate('dealers/grid.phtml');
    }
    ...
    protected function _prepareCollection()
    {
		...
		echo "{{CategoryID:".$id." Count:".count($collection)."}}";
