<?php
class Cedcoss_Dealers_Block_Addproducts_Items_Grid extends Mage_Adminhtml_Block_Sales_Order_Create_Items_Grid
{
/**
    ...
    {
        parent::__construct();
        $this->setId('dealer_create_search_grid');
    }

    public function getItems()
    {
        $items = array();//$this->getParentBlock()->getItems();
